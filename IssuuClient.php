...
class IssuuClient {
   ...
   * @return void
   */
  public function __construct($publicKey, $privateKey, $apiAddress) {
    $this->_publicKey = $publicKey; // Public API key here
    $this->_privateKey = $privateKey; // Private API key here
  ...
  protected function prepareData() {
	...
	$this->_data['resultOrder'] = 'desc';
	
	if( $this->_actionName == 'issuu.documents.list')
    	$this->_data['responseParams'] = 'title,username,name,documentId';
	if( $this->_actionName == 'issuu.document_embeds.list' )
		$this->_data['responseParams'] = 'id,documentId';
